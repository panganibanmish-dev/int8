...
<html>
  <head>
        ...
        <link href="<?php echo base_url(); ?>assets/dist/css/AdminLTE.min.css" rel="stylesheet" type="text/css" />
         <link rel="icon" type="image/png" href="<?php echo base_url(); ?>/assets/img//Integra_Favicon.png" >
  ...
  <body class="login-page">
        <div class="login-box">
            <div class="login-logo">
                <a href="#"><b>Reset Password</b><br><h5>Enter Email to reset your password</h5></a>
            </div><!-- /.login-logo -->
